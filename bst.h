...
public:
    ...
    void setRoot(Node<Key, Value>* temp);
...
typename BinarySearchTree<Key, Value>::iterator& BinarySearchTree<Key, Value>::iterator::operator++()
{
    ...
    {
        Node<Key, Value>* parentCurrent = mCurrent->getParent();

        while(parentCurrent != NULL && mCurrent == parentCurrent->getRight())
        {
            mCurrent = parentCurrent;
...
template<typename Key, typename Value>
void BinarySearchTree<Key, Value>::setRoot(Node<Key, Value>* temp)
{
    mRoot = temp;
}
...
Node<Key, Value>* BinarySearchTree<Key, Value>::getSmallestNode() const
{
    ...
    // always go as far left as possible
